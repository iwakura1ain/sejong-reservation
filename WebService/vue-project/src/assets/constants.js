...
export const BASE_URL = {
    // TODO: 실제로 배포하게 되면 아래 속성들을 사용합니다. -> DONE
    USER_SERVICE: `http://${SERVICE_IP}:${SERVICE_PORT}/userservice`,
    ADMIN_SERVICE: `http://${SERVICE_IP}:${SERVICE_PORT}/adminservice`,
    RESERVATION_SERVICE: `http://${SERVICE_IP}:${SERVICE_PORT}/reservationservice`,
    //ALERT_SERVICE: `http://${SERVICE_IP}:${SERVICE_PORT}/alert`,
    //WEB_SERVICE : `http://${SERVICE_IP}/`,
